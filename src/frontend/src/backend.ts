...
import type { EmailSettings as _EmailSettings, UserProfile as _UserProfile, UserRole as _UserRole } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async deleteEmail(arg0: bigint): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.deleteEmail(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getHistory(): Promise<Array<EmailEntry>> {
        if (this.processError) {
            try {
    ...
    async hasHistory(): Promise<boolean> {
        if (this.processError) {
            try {
                const result = await this.actor.hasHistory();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async saveEmail(arg0: string, arg1: string, arg2: string, arg3: string): Promise<EmailEntry> {
        if (this.processError) {
            try {
                const result = await this.actor.saveEmail(arg0, arg1, arg2, arg3);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async saveSettings(arg0: EmailSettings): Promise<void> {
        if (this.processError) {
            try {
...
function from_candid_opt_n6(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_EmailSettings]): EmailSettings | null {
    return value.length === 0 ? null : value[0];
}
